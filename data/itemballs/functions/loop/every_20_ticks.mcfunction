...
execute as @e[type=minecraft:wandering_trader,tag=itemballs.trigger] at @s positioned ~ ~.75 ~ unless entity @e[type=minecraft:armor_stand,tag=itemballs.marker,distance=...5] run tp ~ -1000 ~
